...
export function PodcastsScreen() {
  ...
  async function loadPodcasts() {
    try {
      setLoading(true);
      const data = await apiCall('/podcasts');
      setPodcasts(data);
    } catch (error) {
  ...
  async function handlePlay(podcastId: number) {
    try {
      await apiCall(`/podcasts/${podcastId}/play`, { method: 'POST' });
  ...
  return (
    <div className="pb-32">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.15),transparent_60%)]"></div>
                  ...
                  <div className="flex gap-4">
                    <div className="relative flex-shrink-0">
                      <button 
                        ...
                        className="h-20 w-20 bg-gradient-to-br from-primary/20 to-emerald-500/20 rounded-2xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform"
                      >
