...
import { X, AtSign, Mail, User } from "lucide-react";
...
export function TaggingInput({ tags, onTagsChange, className = "" }: TaggingInputProps) {
  ...
  // User search for @username autocomplete
    ...
    <div className={`space-y-4 ${className}`}>
      <div>
        ...
        <div className="text-xs text-muted-foreground mt-2 space-y-1">
          <p>• Type @username to tag registered members</p>
          <p>• Use "Tag by Email" to tag people who aren't members yet</p>
          <p>• Select a relationship category for more meaningful notifications</p>
        </div>
      </div>
    </div>
  );
