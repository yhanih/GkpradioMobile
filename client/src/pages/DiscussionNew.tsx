...
import { useCreateThread } from "@/hooks/useSupabase";
            ...
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <FormItem>
                        ...
                        <Select 
                          onValueChange={(value) => {
                            ...
                            // Clear tagged spouse if category changes from spouse categories
                  ...
                  {/* Spouse Tagging Field - Shows only for spouse categories */}
